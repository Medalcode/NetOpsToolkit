...
export const ipReferenceData = {
    classes: [
        { class: 'A', range: '1.0.0.0 - 127.255.255.255', mask: '255.0.0.0', cidr: '/8', type: 'Unicast Large' },
        { class: 'B', range: '128.0.0.0 - 191.255.255.255', mask: '255.255.0.0', cidr: '/16', type: 'Unicast Medium' },
        { class: 'C', range: '192.0.0.0 - 223.255.255.255', mask: '255.255.255.0', cidr: '/24', type: 'Unicast Small' },
        { class: 'D', range: '224.0.0.0 - 239.255.255.255', mask: 'N/A', cidr: 'N/A', type: 'Multicast' },
        { class: 'E', range: '240.0.0.0 - 255.255.255.255', mask: 'N/A', cidr: 'N/A', type: 'Experimental' }
    ],
    private: [
