export function initPublicIpWidget() {
  ...
  async function fetchIp() {
    ...
    try {
        ...
        container.innerHTML = `<div style="color:var(--color-error); font-size:0.9rem;">Error al obtener IP. <button id="btn-retry-ip" style="background:none; border:none; color:var(--color-primary); cursor:pointer; text-decoration:underline;">Reintentar</button></div>`;
